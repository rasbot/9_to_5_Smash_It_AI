...
namespace DigitalRuby.LightningBolt
{
    ...
    public class LightningBoltScript : MonoBehaviour
    {
        ...
        public static Collider[] enemiesNear; //array of all enemies near glove
        ...
        private void Start()
        {
            ...
            StartObject = GameObject.FindGameObjectWithTag("Glove");
        ...
        public void Trigger()
        {
            enemiesNear = Physics.OverlapSphere(this.transform.position, 5f);
            //foreach (Collider enemCol in )
            Vector3 start, end;
